...
public class BasisPage extends LubCont {
	...
	private final JTxtField bsjtf = new JTxtField();
	private final JTxtField bjtf = new JTxtField();
	private final JTxtField lvjtf = new JTxtField();
	private final JTxtField cjtf = new JTxtField();
	private final JTxtField ujtf = new JTxtField();
